...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="text-center text-dark">Create Customer
                <a href="{{ route('all.customers') }}" class="btn btn-info" style="float: right">All Customers</a>
            </h3>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <form action="{{ route('store.customer') }}" method="post">
                        ...
                        <div class="form-group">
                            <button class="btn btn-info btn-block" type="submit">Create Customer</button>
                        </div>
                    </form>
                </div>
            </div>
